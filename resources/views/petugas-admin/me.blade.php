...
<div class="max-w-7xl mx-auto p-6">
    ...
    <div class="bg-white shadow-xl rounded-2xl overflow-hidden">
        ...
        <div class="p-4 border-b flex justify-between items-center flex-wrap gap-3">
            ...
            <!-- ✅ FILTER -->
            <form method="GET" action="{{ route('me') }}" class="flex items-center gap-3">
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('me.export-excel', ['month' => request('month')]) }}"
                    class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg shadow">
                    Export Excel
                </a>

                <a href="{{ route('me.export-pdf', ['month' => request('month')]) }}"
