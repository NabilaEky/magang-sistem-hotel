...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white border rounded-xl shadow p-6 mb-10">
        <form method="GET" action="{{ route('keluhan') }}">
    ...
    <div class="flex justify-end mb-4 relative">
        ...
        <div id="dropdownCetak"
            ...
            <a href="{{ route('civil') }}" class="block px-4 py-2 hover:bg-gray-100">Civil</a>
            <a href="{{ route('me') }}" class="block px-4 py-2 hover:bg-gray-100">ME</a>
            <a href="{{ route('cetak') }}" class="block px-4 py-2 hover:bg-gray-100">Daftar Keluhan</a>
                ...
                <tr class="border-t hover:bg-gray-50 transition">
                    ...
                    <td class="p-3">
                        <div class="flex gap-2 justify-center">
                            <a href="{{ route('detail-keluhan', $k->id) }}" class="bg-gray-500 text-white px-3 py-1 rounded">Detail</a>
                            <a href="{{ route('edit-keluhan', $k->id) }}" class="bg-orange-500 text-white px-3 py-1 rounded">Edit</a>
