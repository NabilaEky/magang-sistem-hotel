...
<div class="max-w-5xl mx-auto space-y-8">
    ...
    <div class="bg-white shadow-lg rounded-xl p-8">
        ...
        <div class="flex items-center justify-between flex-wrap gap-4">
            ...
            {{-- Notifikasi --}}
            <form method="POST" action="{{ route('petugas.toggle-notif') }}">
    @csrf
    ...
    <div class="flex border rounded-lg overflow-hidden">
        ...
        <button type="submit"
            ...
            {{ $user->notifications ? 'bg-green-500 text-white' : 'bg-gray-200' }}">
            ON
        </button>

        <button type="submit"
            class="px-4 py-1 text-sm 
            {{ !$user->notifications ? 'bg-red-500 text-white' : 'bg-gray-200' }}">
            OFF
        </button>
