            ...
            <div class="space-y-4 text-gray-700">
                ...
                <div class="flex justify-between">
                    ...
                    <span class="px-3 py-1 text-sm rounded-full
                        ...
                        @elseif($complaint->status == 'proses') bg-yellow-100 text-yellow-600
...
<div>
    ...
    @php
        $fotos = is_array($complaint->bukti_foto)
            ? $complaint->bukti_foto
            : json_decode($complaint->bukti_foto, true);
    @endphp
...
<div>
    ...
    @php
        $fotosSelesai = is_array($complaint->foto_selesai)
            ? $complaint->foto_selesai
            : json_decode($complaint->foto_selesai, true);
    @endphp
