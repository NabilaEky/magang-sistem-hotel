    ...
    public function store(Request $request)
{
    ...
    $request->validate([
        ...
        'before.*' => 'nullable|image|mimes:jpg,jpeg,png|max:2048',
        'progress.*' => 'nullable|image|mimes:jpg,jpeg,png|max:2048',
        'after.*' => 'nullable|image|mimes:jpg,jpeg,png|max:2048',
    ]);
